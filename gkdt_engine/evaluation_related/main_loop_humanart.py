...
def validate(cfg, model, test_loader, **kwargs):
    ...
    #output_pred_file = "/project/vonneumann1/cl2025/GKD/experiments/evaluation_for_coco/annotations/output_person_keypoints_val2017.json"
    ...
    output_pred_file = f"/project/vonneumann1/cl2025/GKD/experiments/evaluation_for_coco/predict_annotations_result/output_{cfg.DATASET.TEST_DATA[0][1]}"
