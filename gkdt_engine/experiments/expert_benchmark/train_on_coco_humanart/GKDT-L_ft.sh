#!/bin/bash
#SBATCH --job-name=gkd_ft        # create a short name for your job
...
srun torchrun \
    ...
    main_gkd.py --cfg_file experiments/expert_benchmark/configs/gkd_coco_humanart.yaml \
    OUTPUT_DIR output/expert_benchmark/coco_humanart/GKDT-L_ft \
    MODEL.DETECTION_HEAD.IM_FEAT_UPSAMPLER.TYPE 'bilinear' \
    TRAIN.MIX_MODAL_TRAINING.TYPE None \
