...
def load_dinov3_visual_encoder(DINOv3_REPO_DIR, weights_root, dinov3_visual_encoder_name, visual_layer_to_tune):
    ...
    dinov3_visual_encoder = torch.hub.load(DINOv3_REPO_DIR, dinov3_visual_encoder_name, source='local', weights=pretrained_path, visual_layer_to_tune=visual_layer_to_tune)
...
def load_dinov3_text_encoder(DINOv3_REPO_DIR, weights_root, dinov3_text_encoder_name, text_layer_to_tune):
    ...
    dinov3_text_encoder, tokenizer = torch.hub.load(DINOv3_REPO_DIR, dinov3_text_encoder_name, source='local', weights=pretrained_path, text_layer_to_tune=text_layer_to_tune)
