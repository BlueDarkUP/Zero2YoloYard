...
def compute_keypoints_pck(result_file, original_gt_file, pck_threshold=[0.1, 0.05], match_method=1):
    """
...
def main():
    ...
    # 执行评估
    results = compute_keypoints_pck(args.pred_file, args.original_gt_file, args.pck_threshold, args.match_method)
