...
original_gt_file=/project/vonneumann1/cl2025/keypoint_datasets/animal_pose/topviewmouse5k/annotations/test.json
output_pred_file=/project/vonneumann1/cl2025/GKD/more_investigate/top_down_get_GKD_json_results/result_json_F_measure/topviewmouse5k_grounddino_our_results.json
...
python3 more_investigate/top_down_get_GKD_json_results/main_gkd.py \
    ...
    DATASET.TEST_DATA [['topviewmouse5k','topviewmouse5k_grounddino_results_F_measure_select.json',[],[]]]
