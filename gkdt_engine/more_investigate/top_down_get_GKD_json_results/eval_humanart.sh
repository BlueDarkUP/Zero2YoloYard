...
output_pred_file=/project/vonneumann1/cl2025/GKD/more_investigate/top_down_get_GKD_json_results/result_json/humanart_grounddino_results_v2_gkd_fliptest_gaussian_gkd_finetune.json
...
python evaluation_metric/coco_eval_ap.py  \
--pred_file /project/vonneumann1/cl2025/GKD/more_investigate/top_down_get_GKD_json_results/humanart_our_score/humanart_grounddino_results_v2_gkd_fliptest_gaussian_gkd_finetune.json \
--original_gt_file  /project/vonneumann1/cl2025/keypoint_datasets/human_pose/human_art/annotations/validation_humanart.json
