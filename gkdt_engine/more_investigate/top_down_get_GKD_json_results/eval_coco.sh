...
output_pred_file=/project/vonneumann1/cl2025/GKD/more_investigate/top_down_get_GKD_json_results/result_json/COCO_val2017_detections_AP_H_56_person_keypoints_gkd_finetune.json

#for coco and humanart, it should use main_gkd_flip_test_gaussian.py for eval，as they are human_pose
python3 more_investigate/top_down_get_GKD_json_results/main_gkd_flip_test_gaussian.py \
    ...
    DATASET.TEST_DATA [['coco_val','COCO_val2017_detections_AP_H_56_person_keypoints.json',[],[]]] \
    DATASET.PAD_KPS.SAME_AT_TEST True
...
python evaluation_metric/coco_eval_ap.py  \
--pred_file /project/vonneumann1/cl2025/GKD/more_investigate/top_down_get_GKD_json_results/coco_our_score/COCO_val2017_detections_AP_H_56_person_keypoints_gkd_finetune.json \
--original_gt_file /project/vonneumann1/cl2025/keypoint_datasets/human_pose/coco/annotations/person_keypoints_val2017.json
