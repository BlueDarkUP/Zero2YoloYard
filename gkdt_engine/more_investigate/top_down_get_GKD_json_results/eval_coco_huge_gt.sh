...
output_pred_file=/project/vonneumann1/cl2025/GKD/more_investigate/top_down_get_GKD_json_results/result_json/person_keypoints_val2017_gkd_huge.json
...
python evaluation_metric/coco_eval_ap.py  \
--pred_file /project/vonneumann1/cl2025/GKD/more_investigate/top_down_get_GKD_json_results/coco_our_score/person_keypoints_val2017_gkd_huge.json \
--original_gt_file /project/vonneumann1/cl2025/keypoint_datasets/human_pose/coco/annotations/person_keypoints_val2017.json
