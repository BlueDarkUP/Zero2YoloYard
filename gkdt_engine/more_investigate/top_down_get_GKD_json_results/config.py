...
def update_config():
    ...
    parser.add_argument('--output_pred_file', type=str, default='/project/vonneumann1/cl2025/GKD/more_investigate/top_down_get_GKD_json_results/result_json/ap10k_grounddino_our_results.json')
    ...
    cfg.OUTPUT_PRED_FILE = args.output_pred_file  # used in more_investigate/top_down_get_GKD_json_results
    #---------------------------
