...
output_pred_file=/project/vonneumann1/cl2025/GKD/more_investigate/top_down_get_GKD_json_results/result_json/coco_grounddino_results_v2_gkd_huge.json
...
python3 more_investigate/top_down_get_GKD_json_results/main_gkd_flip_test_gaussian.py \
    ...
    DATASET.TEST_DATA [['coco_val','coco_grounddino_results_v2.json',[],[]]] \
    DATASET.PAD_KPS.SAME_AT_TEST True
...
python evaluation_metric/coco_eval_ap.py  \
--pred_file /project/vonneumann1/cl2025/GKD/more_investigate/top_down_get_GKD_json_results/coco_our_score/coco_grounddino_results_v2_gkd_huge.json \
--original_gt_file /project/vonneumann1/cl2025/keypoint_datasets/human_pose/coco/annotations/person_keypoints_val2017.json
